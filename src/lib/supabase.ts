...
const supabaseUrl = (import.meta.env.VITE_SUPABASE_URL as string) || 'https://fashionfit-ai-demo.supabase.co';
const supabaseAnonKey = (import.meta.env.VITE_SUPABASE_ANON_KEY as string) || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZhc2hpb25maXQtYWktZGVtbyIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNjczODQ4ODAwLCJleHAiOjIwMTk0MjQ4MDB9.dummyFallbackKey';
